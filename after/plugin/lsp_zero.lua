...
lsp_zero.on_attach(function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>ac", function() vim.lsp.buf.code_action() end, opts) -- auto complete (code actions)
...
require('mason-lspconfig').setup({
	ensure_installed = {'tsserver', 'rust_analyzer', 'emmet_ls', 'eslint', 'angularls@16.2.0', 'tailwindcss', 'html'},
	handlers = {
